...
export const mockItinerary: ItineraryDay[] = [
  {
    ...
    description:
      "Arrive at your destination where our representative will greet you. Transfer to your hotel and enjoy a welcome dinner with your group featuring local Bangladeshi cuisine.",
    activities: [
      {
        type: "transfer",
        time: "3:00 PM",
        description: "Airport or bus terminal pickup",
      },
      {
        type: "food",
        time: "7:00 PM",
        description:
          "Welcome dinner with fresh seafood or regional specialties",
      },
      {
        type: "hotel",
        time: "Overnight",
        description: "Comfortable eco-resort or heritage stay",
      },
    ],
  },
  {
    ...
    description:
      "Discover the rich history and culture of the region with a guided tour of key landmarks and hidden gems.",
    activities: [
      { type: "tour", time: "9:00 AM", description: "Guided local tour" },
      {
        type: "food",
        time: "1:00 PM",
        description: "Authentic Bangladeshi lunch",
      },
  ...
  },
  {
    ...
    description:
      "Embark on an exciting outdoor adventure through breathtaking natural landscapes unique to Bangladesh.",
    activities: [
      {
        type: "tour",
        time: "8:00 AM",
        description: "Hiking or boat expedition",
      },
      {
        type: "food",
        time: "12:30 PM",
        description: "Picnic with local fruits and snacks",
      },
      {
        type: "tour",
        time: "2:00 PM",
        description: "Wildlife or scenic spotting",
      },
    ],
  },
];
...
export const mockTours: Tour[] = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        reviewText:
          "The beach is stunning! Guides were amazing, and the itinerary perfectly balanced relaxation and adventure.",
      ...
      },
      {
        ...
        rating: 4,
        reviewText:
          "Great value for money. Loved the sunset boat rides and local food experiences.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        reviewText:
          "Unforgettable wildlife spotting! The eco-cruise was safe and informative.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        reviewText:
          "Tea tasting and hill treks were highlights. Sylhet's tranquility is magical.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        reviewText:
          "Breathtaking views from the hills! The tribal cultural experiences were enriching.",
  ...
  },
  {
    ...
    reviews: [
      {
        id: "6",
        username: "Rahul Islam",
        rating: 4,
        reviewText:
          "Snorkeling was world-class. Island vibes are pure relaxation.",
  ...
  },
  {
    ...
    reviews: [
      {
        id: "7",
        username: "Ruma Sultana",
        rating: 5,
        reviewText:
          "Jeep rides through the hills were thrilling. Loved the local hospitality.",
...
export const mockReviews: Review[] = [
  {
    ...
    rating: 5,
    reviewText:
      "Next Go turned our Cox's Bazar trip into a dream! The beach activities and local guides were top-notch. Planning our next to Sundarbans already.",
    createdAt: "2025-01-15",
  ...
  },
  {
    ...
    rating: 4,
    reviewText:
      "Excellent organization for the Sylhet tour. Tea gardens were lush, though early starts for hikes. Highly recommend for nature lovers.",
    createdAt: "2025-01-10",
  ...
  },
  {
    ...
    rating: 5,
    reviewText:
      "Sajek Valley exceeded expectations! The hill treks and cultural immersion were authentic. Next Go handles all logistics seamlessly.",
    createdAt: "2025-01-05",
...
export const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    description:
      "Next Go made our Cox's Bazar vacation unforgettable! The endless beach, sunset cruises, and attentive guides created magical moments. Eager for more Bangladesh adventures!",
  ...
  },
  {
    ...
    rating: 5,
    description:
      "As a photographer, Sundarbans offered endless shots of mangroves and wildlife. Next Go's eco-tours hit all the hidden spots with expert local knowledge.",
  ...
  },
  {
    ...
    rating: 4,
    description:
      "The Sylhet tea gardens were perfect for our family. Comfortable stays and kid-friendly activities made it stress-free. Next Go's service shines.",
  ...
  },
  {
    ...
    rating: 5,
    description:
      "Sajek's hill treks were exhilarating! Next Go ensured safe paths and cultural respect. Best way to explore Bangladesh's highlands.",
  ...
  },
  {
    ...
    rating: 5,
    description:
      "St. Martin's snorkeling was a highlight for solo travel. Roamio provided secure group options and made new friends easy to meet.",
  ...
  },
  {
    ...
    rating: 4,
    description:
      "Bandarban's jeep safaris suited my pace perfectly. Next Go's thoughtful planning allowed relaxation amid the adventures.",
...
export const faqs: FAQ[] = [
  {
    id: "1",
    question: "How do I book a tour with Next Go?",
    answer:
      "Booking with Next Go is simple! You can book directly through our website by selecting your desired Bangladesh tour, choose your dates and number of travelers, and complete the secure payment in BDT. Alternatively, contact our Dhaka-based travel experts.",
    category: "Booking",
  },
  {
    id: "2",
    ...
    answer:
      "Our tour prices in BDT include accommodation, guided tours, transportation during the tour, some meals with local Bangladeshi flavors, and entrance fees. Flights/trains, insurance, and personal expenses are extra. Check each tour for details.",
    category: "Pricing",
  },
  {
    id: "3",
    ...
    answer:
      "Absolutely! We specialize in personalized Bangladesh experiences. Customize tours to Bangladesh destinations or create bespoke itineraries for places like Cox's Bazar or Sundarbans.",
  ...
  },
  {
    ...
    answer:
      "Flexible policies: Cancel up to 30 days before for full refund in BDT. Premium tours may vary. We recommend travel insurance for Bangladesh trips.",
  ...
  },
  {
    ...
    answer:
      "Yes! Discounts for groups of 6+ on Bangladesh tours, 5-15% off based on size. Contact for quotes on trips to Sylhet or Sajek.",
  ...
  },
  {
    ...
    answer:
      "Safety first: Certified guides, small groups, 24/7 support, and compliance with Bangladesh tourism standards. Eco-friendly practices for Sundarbans and hills.",
    category: "Safety",
  },
  {
    id: "7",
    ...
    answer:
      "Book 2-3 months ahead for popular spots like Cox's Bazar. Exclusive hill tracts tours need 6+ months. Last-minute available seasonally.",
    category: "Booking",
  },
  {
    id: "8",
    ...
    answer:
      "Yes, partner with local providers for Bangladesh-focused coverage. Add during booking or get help from our team.",
    category: "Insurance",
  },
];
...
export const teamMembers = [
  {
    name: "Mahamud Pino",
    role: "Founder & CEO",
    bio: "With 15+ years in Bangladesh tourism, Rahima founded Next Go to showcase our hidden gems like Sundarbans and tea gardens.",
    email: "mahamudpino24678@gmail.com",
    phone: "+880 1789 999751 ",
    location: "Dhaka",
    image:
      "https://i.ibb.co.com/5Xn4xkyS/512951507-9967383630005231-6578144722306656845-n-1.jpg",
  },
  {
    name: "Niloy",
    role: "Head of Operations",
    bio: "Faruq manages seamless tours across Bangladesh, from Cox's Bazar to Chittagong Hills, with hospitality expertise.",
    email: "faruq@nextGo.bd",
    phone: "+880 1711 123457",
    location: "Chittagong",
    image:
      "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80", // Professional male
  },
  {
    name: "Mahamud Hasan",
    ...
    location: "Sylhet",
    image:
      "https://i.ibb.co.com/S4JLN6jq/301606331-5379773852143535-4322268337082882420-n.jpg",
  },
];
