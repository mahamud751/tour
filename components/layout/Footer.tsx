...
export const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: Facebook,
      href: "https://web.facebook.com/profile.php?id=61582634602384",
      label: "Facebook",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8 lg:gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-3 xl:col-span-2 space-y-6">
            ...
            <div className="flex gap-3 pt-2">
              ...
              {/* WhatsApp Icon */}
              <a
                href="https://wa.me/+8801877570490"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-neutral-800 rounded-lg text-neutral-400 hover:text-green-500 hover:bg-neutral-700 transition-all duration-300 hover:scale-110"
                aria-label="WhatsApp"
              >
