  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-coral-50 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 left-10 w-64 h-64 bg-coral-100 rounded-full blur-3xl opacity-30 animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary-50 rounded-full blur-3xl opacity-20 animate-float" style={{ animationDelay: '4s' }} />
      </div>
          ...
          <div className="relative inline-block">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <div className="w-20 h-20 md:w-24 md:h-24 bg-white rounded-full shadow-2xl flex items-center justify-center animate-pulse-slow">
                <Compass className="w-10 h-10 md:w-12 md:h-12 text-primary-600 animate-spin" style={{ animationDuration: '8s' }} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card-elevated p-8 bg-white/80 backdrop-blur-sm max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="text-sm font-medium text-neutral-700 group-hover:text-primary-600">Home</span>
            </Link>
            ...
            >
              ...
              <span className="text-sm font-medium text-neutral-700 group-hover:text-primary-600">Tours</span>
            </Link>
            ...
            >
              ...
              <span className="text-sm font-medium text-neutral-700 group-hover:text-primary-600">Blog</span>
            </Link>
            ...
            >
              ...
              <span className="text-sm font-medium text-neutral-700 group-hover:text-primary-600">Contact</span>
            </Link>
          </div>
        </div>
