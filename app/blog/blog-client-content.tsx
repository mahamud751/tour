      ...
      <section className="relative bg-white py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10 max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-neutral-600 max-w-2xl mx-auto leading-relaxed">
            Discover travel guides, destination tips, adventure stories, and
            expert advice for your next journey
          </p>
        </div>
      </section>
        ...
        <section>
          ...
          {filteredBlogs.length > 0 ? (
            ...
            <div className="text-center py-16 px-4">
              ...
              <h3 className="heading-tertiary text-neutral-900 mb-3">
                No Articles Found
              </h3>
      ...
      <section className="bg-gradient-to-r from-primary-500 to-primary-600 py-16 px-4 mt-16">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-primary-50 text-lg mb-8 leading-relaxed">
            Subscribe to our newsletter and get the latest travel stories, tips,
