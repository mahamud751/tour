...
export const sampleBlogs: BlogPost[] = [
  {
    ...
    excerpt: 'Discover the world\'s longest natural sea beach with Roamio. From sunset strolls to island hopping, plan your perfect coastal escape.',
    content: `
      <p>Cox\'s Bazar, stretching 120km of golden sands, is Bangladesh\'s crown jewel for beach lovers. At Roamio, our tours unlock its hidden charms beyond the crowds.</p>
  ...
  },
  {
    ...
    excerpt: 'Venture into UNESCO\'s mangrove wilderness with Roamio. Learn safe wildlife viewing and eco-practices for an unforgettable expedition.',
    content: `
      <p>The Sundarbans, home to the Royal Bengal Tiger, is a biodiversity hotspot. Roamio\'s expert-guided cruises ensure thrilling yet responsible encounters.</p>
  ...
  },
  {
    ...
    excerpt: 'Wander through rolling tea estates and misty waterfalls with Roamio. Unwind in Northeast Bangladesh\'s tranquil paradise.',
    content: `
      <p>Sylhet\'s lush tea gardens offer a peaceful retreat from city hustle. Roamio tours blend plantation walks with cultural immersion.</p>
  ...
  },
  {
    ...
    excerpt: 'Conquer misty trails in the Chittagong Hill Tracts with Roamio. Meet indigenous communities and chase sunrises from the roof of Bangladesh.',
    content: `
      <p>Sajek Valley, at 2000ft, is a trekker\'s dream of bamboo bridges and cloud seas. Roamio ensures guided, culturally sensitive adventures.</p>
  ...
  },
  {
    ...
    excerpt: 'Dive into turquoise waters and deserted beaches on Roamio\'s island escape. Bangladesh\'s only coral reef calls for underwater exploration.',
    content: `
      <p>St. Martin\'s, a 3-hour boat from Teknaf, is a slice of Maldives in Bangladesh. Roamio tours focus on sustainable marine adventures.</p>
      ...
      <p>Avoid touching reefs; support turtle hatcheries. Roamio promotes reef-safe sunscreen and waste-free travel.</p>
  ...
  },
  {
    ...
    excerpt: 'Roam the Chittagong Hills with Roamio: from Nilgiri\'s cloud views to tribal boat rides. Adventure meets serenity in Bangladesh\'s hill capital.',
    content: `
      <p>Bandarban pulses with Mro and Marma heritage amid rugged peaks. Roamio curates offbeat routes for authentic hill country vibes.</p>
